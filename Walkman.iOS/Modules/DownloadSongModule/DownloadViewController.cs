...
{
    public partial class DownloadViewController : UITableViewController, IDownloadSongView
    {
        private IDownloadSongPresenter _presenter;
        ...
        {
            base.ViewDidLoad();
            _presenter = ServiceProviderFactory.ServiceProvider.GetService<IDownloadSongPresenter>();

            _presenter.ConfigureView(this);

            Task.Run(async () => await _presenter.SetSongsAsync());
        }
